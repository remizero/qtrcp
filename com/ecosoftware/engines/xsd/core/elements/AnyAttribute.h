#ifndef ANYATTRIBUTE_H
#define ANYATTRIBUTE_H
  ...
  namespace Ecosoftware {
    ...
    namespace Engines {
      ...
      namespace Xsd {
        ...
        class XSDSHARED_EXPORT AnyAttribute : public ElementAbs {

            Q_OBJECT
            Q_ENUMS ( content properties )

          public :
            Q_INVOKABLE AnyAttribute ();
            AnyAttribute ( const AnyAttribute& );
            ~AnyAttribute ();
...
Q_DECLARE_METATYPE ( Com::Ecosoftware::Engines::Xsd::AnyAttribute )

#endif // ANYATTRIBUTE_H
